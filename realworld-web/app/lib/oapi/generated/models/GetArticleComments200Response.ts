 ...
 */
export function instanceOfGetArticleComments200Response(
  value: object
): boolean {
  let isInstance = true;
...
export function GetArticleComments200ResponseFromJSON(
  json: any
): GetArticleComments200Response {
  return GetArticleComments200ResponseFromJSONTyped(json, false);
}

export function GetArticleComments200ResponseFromJSONTyped(
  json: any,
...
export function GetArticleComments200ResponseToJSON(
  value?: GetArticleComments200Response | null
): any {
  if (value === undefined) {
    return undefined;
  }
