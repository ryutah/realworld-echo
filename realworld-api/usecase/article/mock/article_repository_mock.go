...
// Source: github.com/ryutah/realworld-echo/realworld-api/domain/article/repository (interfaces: Article)
...
func (m *MockArticle) GenerateID(arg0 context.Context) (model.Slug, error) {
	m.ctrl.T.Helper()
	ret := m.ctrl.Call(m, "GenerateID", arg0)
	ret0, _ := ret[0].(model.Slug)
	ret1, _ := ret[1].(error)
	return ret0, ret1
}
...
func (m *MockArticle) Get(arg0 context.Context, arg1 model.Slug) (*model.Article, error) {
	m.ctrl.T.Helper()
