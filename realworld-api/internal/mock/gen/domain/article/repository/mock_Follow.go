...
// Exists provides a mock function with given fields: ctx, followedBy, following
func (_m *MockFollow) Exists(ctx context.Context, followedBy model.UserID, following model.UserID) (bool, error) {
	ret := _m.Called(ctx, followedBy, following)

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.UserID, model.UserID) (bool, error)); ok {
...
// MockFollow_Exists_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'Exists'
type MockFollow_Exists_Call struct {
	*mock.Call
}
...
func (_e *MockFollow_Expecter) Exists(ctx interface{}, followedBy interface{}, following interface{}) *MockFollow_Exists_Call {
	return &MockFollow_Exists_Call{Call: _e.mock.On("Exists", ctx, followedBy, following)}
}

func (_c *MockFollow_Exists_Call) Run(run func(ctx context.Context, followedBy model.UserID, following model.UserID)) *MockFollow_Exists_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(context.Context), args[1].(model.UserID), args[2].(model.UserID))
	})
	return _c
}

func (_c *MockFollow_Exists_Call) Return(_a0 bool, _a1 error) *MockFollow_Exists_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockFollow_Exists_Call) RunAndReturn(run func(context.Context, model.UserID, model.UserID) (bool, error)) *MockFollow_Exists_Call {
	_c.Call.Return(run)
	return _c
}
