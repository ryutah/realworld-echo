...
func (_m *MockDBManager) BeginTx(_a0 context.Context, _a1 pgx.TxOptions) (pgx.Tx, error) {
...
func (_c *MockDBManager_BeginTx_Call) Run(run func(_a0 context.Context, _a1 pgx.TxOptions)) *MockDBManager_BeginTx_Call {
...
func (_c *MockDBManager_BeginTx_Call) Return(_a0 pgx.Tx, _a1 error) *MockDBManager_BeginTx_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockDBManager_BeginTx_Call) RunAndReturn(run func(context.Context, pgx.TxOptions) (pgx.Tx, error)) *MockDBManager_BeginTx_Call {
	_c.Call.Return(run)
	return _c
}
